...
export default function Home() {
  ...
  return (
    <SafeAreaView className='flex-1 ' edges={["top"]}>
      <Header title="Forever"  showMenu showCart  showBack showLogo  />
      ...
      showsVerticalScrollIndicator={false}>
          ...
          <View className='mb-6'>
              ...
              {BANNERS.map((_, index) => (
                <View
                  ...
                  className={`h-2 rounded-full ${
                    index === activeBannerIndex ? "bg-primary w-6" : "bg-gray-300 w-2"
                  }`}
                />
              ))}
            </View>
             ...
             <View className='mb-8'>
              <View className='flex-row justify-between items-center mb-4'>
                <Text className='text-xl font-bold
                 text-primary'>Popular Products</Text>
            ...
            items-center '>
               <Text className='text-2lx font-bold text-primary mb-2 text-center '>Join the Revolution </Text>
